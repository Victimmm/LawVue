        ...
        <div class="layui-card-body">
            <form class="layui-form" action="" onsubmit="return false">
                ...
                <div  v-if="data.accuser_type=='1'">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" v-model="data.accuser"  placeholder="请输入原告全称" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" v-model="data.accuser_short" placeholder="请输入原告简称" autocomplete="off" class="layui-input">
                    </div>
                </div>
            ...
            <div class="layui-form-item">
              <div class="layui-input-block">
                ...
                <button type="button" v-show="this.index!=0" class="layui-btn layui-btn-radius layui-btn-danger" @click="onCloseClick"> 删除</button>
