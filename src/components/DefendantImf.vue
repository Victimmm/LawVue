      ...
      <form class="layui-form layui-form-pane" action="" >
        <div class="layui-form-item" pane>
              ...
              <div class="layui-input-block">
                ...
                <input type="radio" name="plaintiffType" v-model="data.defendant_type" class="myradio" value="0" ><label >单位</label>
                <input type="radio" name="plaintiffType" v-model="data.defendant_type" class="myradio" value="1" style="margin-left: 15px;"><label >个人</label>
                </div>
              </div>
        </div>
