...
<!--        &lt;!&ndash;        <div class="layui-form-item" pane>&ndash;&gt;-->
<!--        &lt;!&ndash;          <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">&ndash;&gt;-->
<!--        &lt;!&ndash;            <div class="layui-input-inline" style="margin-left:0px ;">&ndash;&gt;-->
<!--        &lt;!&ndash;              <VueMultiselect :option-height="38"  :show-labels="false" v-model="data.final_statement_info[0].name"&ndash;&gt;-->
<!--        &lt;!&ndash;                              :options="finalStateFormGetAccuserMergeDefendant" placeholder="请选择原被告"&ndash;&gt;-->
<!--        &lt;!&ndash;                              lay-verify="vueselect"&ndash;&gt;-->
<!--        &lt;!&ndash;                              style="line-height: 16px;width: 210px; min-height: 38px"></VueMultiselect>&ndash;&gt;-->
<!--        &lt;!&ndash;            </div>&ndash;&gt;-->
<!--        &lt;!&ndash;            <div class="layui-input-block">&ndash;&gt;-->
<!--        &lt;!&ndash;              <div class="myselect-div">&ndash;&gt;-->
<!--        &lt;!&ndash;                <input type="text" v-model="data.final_statement_info[0].final_statement"   placeholder="最后陈述意见" autocomplete="off"&ndash;&gt;-->
<!--        &lt;!&ndash;                       class="layui-input" style="width: 90%;float: left;">&ndash;&gt;-->
<!--        &lt;!&ndash;                <button @click="add_component('final_statement_info')" type="button" class="layui-btn layui-btn-primary layui-btn-sm"&ndash;&gt;-->
...
<!--                &lt;!&ndash;                  <button @click="delete_component('final_statement_info',index)" type="button" class="layui-btn layui-btn-primary layui-btn-sm"&ndash;&gt;-->
<!--                &lt;!&ndash;                          data-type="text" style="float: right;">&ndash;&gt;-->
<!--                &lt;!&ndash;                    <i class="layui-icon">&#xe640;</i>&ndash;&gt;-->
<!--                &lt;!&ndash;                  </button>&ndash;&gt;-->
<!--              </div>-->
