        ...
        <div class="layui-form-item" pane>
          <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">
            <div class="layui-input-inline" style="margin-left:0px ;">
              <input type="text" v-model="data.accshowd_evidence[0].accshow_evidence" placeholder="证据名称"
                     autocomplete="off"
                     class="layui-input" style="line-height: 16px;width: 160px; min-height: 38px">
            </div>
            <div class="layui-input-block">
              <div class="myselect-div">
                <input type="text" v-model="data.accshowd_evidence[0].accshow_content" placeholder="证明事项"
                       autocomplete="off"
          ...
          <template v-for="(item, index) in data.accshowd_evidence.slice(1)" :key="index">
            <div class="layui-inline" style="width: 100%;margin-bottom:0px;margin-top:5px; height: 38px;">
              <div class="layui-input-inline" style="margin-left:0px ;">
                <input type="text" v-model="data.accshowd_evidence[index+1].accshow_evidence" placeholder="证据名称"
                       autocomplete="off"
                       class="layui-input" style="line-height: 16px;width: 160px; min-height: 38px">
              </div>
              <div class="layui-input-block">
                <div class="myselect-div">
                  <input type="text" v-model="data.accshowd_evidence[index+1].accshow_content" placeholder="证明事项"
                         autocomplete="off"
          ...
          <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">
            <div class="layui-input-inline" style="margin-left:0px ;">
              <VueMultiselect :option-height="38" :show-labels="false"
                              v-model="data.accshowd_query_evidence[0].accshow_defendant"
        ...
        <div class="layui-form-item" pane>
            ...
            <div class="layui-input-block">
              <div class="myselect-div">
                <div class="myradiomargin" style="width: 100%;float: left;">
                  <input type="radio" value="true" v-model="data.accshowd_query_evidence[0]. accshow_facticity"
                         class="myradio"><label>是</label>
                  <input type="radio" value="false" v-model="data.accshowd_query_evidence[0].accshow_facticity"
          ...
          <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">
            ...
            <div class="layui-input-block">
              <div class="myselect-div">
                <div class="myradiomargin" style="width: 100%;float: left;">
                  <input type="radio" value="true" v-model="data.accshowd_query_evidence[0].accshow_legality"
                         class="myradio"><label>是</label>
                  <input type="radio" value="false" v-model="data.accshowd_query_evidence[0].accshow_legality"
                         class="myradio"><label>否</label>
                </div>
              </div>
            </div>
          ...
          <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">
            ...
            <div class="layui-input-block">
              <div class="myselect-div">
                <div class="myradiomargin" style="width: 100%;float: left;">
                  <input type="radio" value="true" v-model="data.accshowd_query_evidence[0].accshow_relevance"
                         class="myradio"><label>是</label>
                  <input type="radio" value="false" v-model="data.accshowd_query_evidence[0].accshow_relevance"
                         class="myradio"><label>否</label>
                </div>
              </div>
            </div>
        ...
        <template v-for="(item, index) in data.accshowd_query_evidence.slice(1)" :key="index">
          <div class="layui-form-item" pane>
            <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">
              <div class="layui-input-inline" style="margin-left:0px ;">
                <VueMultiselect :option-height="38" :show-labels="false"
                                v-model="data.accshowd_query_evidence[index+1].accshow_defendant"
                                :options="$store.state.defendantname" placeholder="请选择被告"
                                style="line-height: 16px;width: 160px; min-height: 38px"></VueMultiselect>
              </div>
              <div class="layui-input-block">
          ...
          <div class="layui-form-item" pane>
            <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">
              ...
              <div class="layui-input-block">
                <div class="myselect-div">
                  <div class="myradiomargin" style="width: 100%;float: left;">
                    <input type="radio" value="true" v-model="data.accshowd_query_evidence[index+1].accshow_facticity"
                           class="myradio"><label>是</label>
                    <input type="radio" value="false" v-model="data.accshowd_query_evidence[index+1].accshow_facticity"
                           class="myradio"><label>否</label>
                  </div>
                </div>
              </div>
            ...
            <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">
              ...
              <div class="layui-input-block">
                <div class="myselect-div">
                  <div class="myradiomargin" style="width: 100%;float: left;">
                    <input type="radio" value="true" v-model="data.accshowd_query_evidence[index+1].accshow_legality"
                           class="myradio"><label>是</label>
                    <input type="radio" value="false" v-model="data.accshowd_query_evidence[index+1].accshow_legality"
                           class="myradio"><label>否</label>
                  </div>
                </div>
              </div>
            ...
            <div class="layui-inline" style="width: 100%;margin-bottom:0px;height: 38px;">
              ...
              <div class="layui-input-block">
                <div class="myselect-div">
                  <div class="myradiomargin" style="width: 100%;float: left;">
                    <input type="radio" value="true" v-model="data.accshowd_query_evidence[index+1].accshow_relevance"
                           class="myradio"><label>是</label>
                    <input type="radio" value="false" v-model="data.accshowd_query_evidence[index+1].accshow_relevance"
                           class="myradio"><label>否</label>
                  </div>
                </div>
              </div>
