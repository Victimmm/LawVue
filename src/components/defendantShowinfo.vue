        ...
        <div v-if="$store.state.is_counterclaim=='1'">
            ...
            <div class="layui-form-item" pane style="margin-top: -10px;">
              ...
              <div class="layui-input-block">
                <div class="layui-input-inline" style="width:33%;margin-left: 0">
                  <div class="myradiomargin">
                    <label>真实性：</label>
                    <input type="radio" lay-ignore value="1" v-model="data.counterclaim_defendant_query[index].facticity"
                           class="myradio"><label>是</label>
                    <input type="radio" lay-ignore value="2" v-model="data.counterclaim_defendant_query[index].facticity"
                           class="myradio" style="margin-left: 15px;"><label>否</label>
                  </div>
                </div>
                <div class="layui-input-inline" style="width:33%;margin-left: 0">
                ...
                <div class="layui-input-inline" style="width:34%;margin-left: 0">
                  <div class="myradiomargin">
                    <label>相关性：</label>
                    <input type="radio" lay-ignore value="1" v-model="data.counterclaim_defendant_query[index].relevance"
                           class="myradio"><label>是</label>
                    <input type="radio" lay-ignore value="2" v-model="data.counterclaim_defendant_query[index].relevance"
                           class="myradio" style="margin-left: 15px;"><label>否</label>
                  </div>
                </div>
              </div>
          ...
          <template v-for="(item,index) in data.other_counterclaim_defendant_query" :key="index">
            ...
            <div class="layui-form-item" pane style="margin-top: -10px;">
              ...
              <div class="layui-input-block">
                <div class="layui-input-inline" style="width:33%;margin-left: 0">
                  <div class="myradiomargin">
                    <label>真实性：</label>
                    <input type="radio" lay-ignore value="1" v-model="data.other_counterclaim_defendant_query[index].facticity"
                           class="myradio"><label>是</label>
                    <input type="radio" lay-ignore value="2" v-model="data.other_counterclaim_defendant_query[index].facticity"
                           class="myradio" style="margin-left: 15px;"><label>否</label>
                  </div>
                </div>
                <div class="layui-input-inline" style="width:33%;margin-left: 0">
                  <div class="myradiomargin">
                    <label>合法性：</label>
                    <input type="radio" lay-ignore value="1" v-model="data.other_counterclaim_defendant_query[index].legality"
                           class="myradio"><label>是</label>
                    <input type="radio" lay-ignore value="2" v-model="data.other_counterclaim_defendant_query[index].legality"
                           class="myradio" style="margin-left: 15px;"><label>否</label>
                  </div>
                </div>
                <div class="layui-input-inline" style="width:34%;margin-left: 0">
                  <div class="myradiomargin">
                    <label>相关性：</label>
                    <input type="radio" lay-ignore value="1" v-model="data.other_counterclaim_defendant_query[index].relevance"
                           class="myradio"><label>是</label>
                    <input type="radio" lay-ignore value="2" v-model="data.other_counterclaim_defendant_query[index].relevance"
                           class="myradio" style="margin-left: 15px;"><label>否</label>
                  </div>
                </div>
              </div>
            ...
            <div class="layui-form-item" pane style="margin-top: -10px;">
              ...
              <div class="layui-input-block">
              <textarea v-model="data.other_counterclaim_defendant_query[index].counterclaim_defendant_query_fact_reason" 
                        placeholder="理由"
                        class="layui-textarea"></textarea>
              </div>
            </div>
