      ...
      <form class="layui-form layui-form-pane" action="" >
        ...
        <div class="layui-form-item" pane>
          ...
          <div class="layui-input-block">
            <textarea v-model="data.judge_right_duty[0]" type="text" class="layui-input " style="height: 200px;">
            </textarea>
          </div>
        </div>
        ...
        <div class="layui-form-item" pane>
          ...
          <div class="layui-input-block">
            <textarea type="text" v-model="data.judge_avoid[0]" class="layui-textarea"
...
export default {
  ...
  data() {
    var data;
    data = {
      judge_right_duty: ["审判员：依据《中华人民共和国民事诉讼法》的规定，当事人在法庭上享有下列权利：\n" +
