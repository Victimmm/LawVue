      ...
      <form class="layui-form " action="" onsubmit="return false">
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" name="6j8z" required lay-verify="required" autocomplete="off" class="layui-input"
        ...
        <template v-for="(item, index) in data.accuser_claims.slice(1)" :key='index'>
          <div class="layui-form-item" style="margin-top: 11px;">
            <label class="layui-form-label">
              <input type="text" v-model="data.accuser_claims[index+1].accuser_name" placeholder="原告简称"
                     class="layui-input" style="margin-top: -9px;">
            </label>
            <div class="layui-input-inline" style="width: 50%;">
              <div style="float: left;display: inline;width: 80%">
              ...
              <div style="float: right;display: inline ;margin-left: 10px;">
                <div class="layui-btn-group">
                  <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" data-type="text"
                          style="height: 38px;" @click="delete_component('accuser_claims',index+1)">
                    <i class="layui-icon">&#xe640;</i>
                  </button>
                </div>
              </div>
          ...
          <div class="layui-form-item" style="margin-top: 11px;">
            ...
            <div class="layui-input-inline" style="width: 50%;">
              ...
              <div style="float: right;display: inline ;margin-left: 10px;">
                <div class="layui-btn-group">
                  <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" data-type="text"
                          style="height: 38px;" @click="delete_component('defendant_claims',index+1)">
                    <i class="layui-icon">&#xe640;</i>
                  </button>
                </div>
              </div>
        ...
        <div v-show="data.is_counterclaim==1">
          ...
          <template v-for="(item, index) in data.counterclaim_plaintiff.slice(1)" :key='index'>
            <div class="layui-form-item" style="margin-top: 11px;">
              <label class="layui-form-label">
                <input type="text" v-model="data.counterclaim_plaintiff[index+1].accuser_name" placeholder="反诉原告简称"
                       class="layui-input" style="margin-top: -9px;">
              </label>
              <div class="layui-input-inline" style="width: 50%;">
                <div style="float: left;display: inline;width: 80%">
                ...
                <div style="float: right;display: inline ;margin-left: 10px;">
                  <div class="layui-btn-group">
                    <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" data-type="text"
                            style="height: 38px;" @click="delete_component('counterclaim_plaintiff',index+1)">
                      <i class="layui-icon">&#xe640;</i>
                    </button>
                  </div>
                </div>
              ...
              <div class="layui-form-item" style="margin-top: 11px;">
                ...
                <div class="layui-input-inline" style="width: 50%;">
                  ...
                  <div style="float: right;display: inline ;margin-left: 10px;">
                    <div class="layui-btn-group">
                      <button type="button" class="layui-btn layui-btn-primary layui-btn-sm" data-type="text"
                              style="height: 38px;" @click="delete_component('counterclaim_defendant',index+1)">
                        <i class="layui-icon">&#xe640;</i>
                      </button>
                    </div>
                  </div>
